...
const ProductCard = ({photoFull, title, rating, eKnowledge, oldPrice, price, color,ratedPeople}) => {
    ...
    const handleAddToWishlist = () => {
        if (!wishlist.includes(title)) {
            ...
            setWishList((prevWishlist) => [...prevWishlist, title]);
        }
    ...
    return (
        <div className="productCard">
            <div className="productImage">
                <button className={className}  onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)} onClick={() => handleAddToWishlist(title)}>
            ...
            <div className="productDescription">
                ...
                <div className="productRating">
                    {[...Array(rating)].map((index) => (
                        <FontAwesomeIcon id={index + 1} key={index} icon={faStar}/>
                    ))}
