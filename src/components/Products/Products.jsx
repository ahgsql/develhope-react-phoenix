        ...
        <>
            <div className="productRow">
                <div className="productHeader">
                    <h2 className="productHeader"><FontAwesomeIcon icon={faBolt} className="faBolt"/>Top Deals today<FontAwesomeIcon
                        icon={faBolt} className="faBolt"/></h2>
                    <a href="#">Explore More <FontAwesomeIcon icon={faAngleRight} /></a>
                </div>
