...
const Products = () => {
    ...
    return (
        <>
            <Carousel products={products1} isTop={true} header="Top Deals today" ads={ads}/>
            <Carousel products={products2} isTop={false} header="Top Electronics" ads={ads}/>
            <Carousel products={products3} isTop={false} header="Best Offers" ads={ads}/>
        </>
    );
};
