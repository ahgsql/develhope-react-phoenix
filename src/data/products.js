export default [
  [
    ...
    {
      id: 12,
      title: "Elegance Drapes, Curtains",
      description:
    ...
    {
      id: 33,
      title: "FreshBrew, Coffee Maker",
      description:
        "Brew your favorite coffee blend with this programmable coffee maker. 12-cup capacity.",
    ...
    {
      id: 34,
      title: "ArtisanPlates, Dinnerware Set",
      description:
        "Serve your meals in style with this elegant dinnerware set. Includes plates, bowls, and mugs.",
    ...
    {
      id: 35,
      title: "HomeHarmony, Decorative Pillows",
      description:
        "Spruce up your living space with these decorative pillows. Assorted colors and patterns.",
